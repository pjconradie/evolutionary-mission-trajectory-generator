    ...
    int MBH::run()
    {
        ...
        do
        {
            ...
            this->myNLP->setInitializationPolicy(
                consumeMBHInitializationPolicy(seeded_step));
            ...
            const bool isFeasible = acceptNLPSolution(
                this->myProblem->options.enable_NLP_chaperone,
                normalized_feasibility,
                decision_variable_infeasibility,
                myProblem->options.snopt_feasibility_tolerance,
                this->myNLP->getStatus());
