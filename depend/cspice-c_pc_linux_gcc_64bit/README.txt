NOTE: cspice.tar.Z, the Toolkit download package, containing all Toolkit
components in a single compressed file is ignored in the repository.
...
--------------------------------------------------------
   ...
   running Red Hat Enterprise 7.0 Linux using GNU C 7.3.0 compiler in
   64-bit mode. The version of IDL installed on this workstation was 8.8.
   The version of MATLAB installed on this workstation was R2020b. The
...
--------------------------------------------------------
   ...
   Electronic mail address:
      ...
      Fraser.S.Thomson@jpl.nasa.gov
      Edward.D.Wright@jpl.nasa.gov
 
   Phone number:
 
      (818) 354-7454 (Nat Bachman)
      (818) 354-5942 (Matt Barnes)
      (818) 354-4852 (Marc Costa)
      (818) 354-8136 (Boris Semenov)
      (818) 354-1842 (Fraser Thomson)
